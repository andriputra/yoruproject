=== Particle Background ===
Contributors: aasthasolutions, ashvins, 
Tags: Particle, Background,Background with content, Parallax
...
== Description ==
https://www.youtube.com/watch?v=qsIpxJkeMBo
...
1. Upload the entire `particleground` folder to the '/wp-content/plugins/' directory
...
1. **Particle Background - Visibility** - Display content with Particle Background.
